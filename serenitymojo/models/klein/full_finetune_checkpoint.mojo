...
def collect_klein_full_finetune_tensors(
    ...
    """Collect live Klein runtime tensors in SerenityTrainer full-weight key order.
...
def save_klein_full_finetune_checkpoint(
    ...
    opaque trainer parameter indices to the exact SerenityTrainer tensor-name order.
