...
def klein_tiled_decode_with_decoder[
    ...
    var half_h = TILE_H // 2                       # latent row stride
    var half_w = TILE_W // 2                       # latent column stride
...
def klein_tiled_decode_nested_2x[
    ...
    var half_h = OUTER_H // 2
    var half_w = OUTER_W // 2
