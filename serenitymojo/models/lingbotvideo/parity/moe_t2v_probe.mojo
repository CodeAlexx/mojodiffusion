...
def main() raises:
    ...
    save_safetensors(lat_names, lat_tens, String(PARITY_DIR) + "/moe_t2v_latent.safetensors", ctx)
    print("[MoE-T2V] saved moe_t2v_latent.safetensors (pre-VAE)")
    ...
    save_safetensors(names, tens, String(PARITY_DIR) + "/moe_t2v_pixels.safetensors", ctx)
    print("[MoE-T2V] SAVED moe_t2v_pixels.safetensors [0,1] — render:")
    print("  /home/alex/SerenityTrainer/venv/bin/python", String(PARITY_DIR) + "/render_t2v.py",
          String(PARITY_DIR) + "/moe_t2v_pixels.safetensors <out_base> 24 pixels")
