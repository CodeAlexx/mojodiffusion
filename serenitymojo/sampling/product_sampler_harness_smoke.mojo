# Smoke gate for the fail-loud SerenityTrainer product sampler harness contract.
...
def _prompt() -> SamplePrompt:
    return SamplePrompt(
        True,
        String("smoke"),
        String("SerenityTrainer sampler lifecycle smoke"),
        String(""),
        1024,
        1024,
        1,
...
def main() raises:
    print("==== SerenityTrainer product sampler harness smoke ====")
