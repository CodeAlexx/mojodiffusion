...
function runCase(c) {
  return new Promise((resolve, reject) => {
    ...
    if (c.guidance !== undefined) env.SERENITY_VALID_IMAGE_GUIDANCE = String(c.guidance);
...
async function main() {
  ...
  const report = {
    ...
    limits: [
      ...
      "Klein, Qwen-Image, and Krea2 worker-side result manifests remain optional; the Rust server result, artifact, visual-health, and route evidence are still mandatory.",
    ],
  };
