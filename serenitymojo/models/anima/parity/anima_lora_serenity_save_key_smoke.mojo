# anima_lora_serenity_save_key_smoke.mojo -- Anima SerenityTrainer save-key contract.
#
# Tiny structural gate: build one synthetic Anima LoRA block, save through
# save_anima_lora, inspect the raw reference trainer alpha/down/up safetensors header, then
...
comptime OUT = "/tmp/anima_lora_serenity_save_key_smoke.safetensors"
comptime SMOKE_D = 8
...
def main() raises:
    ...
    print("[anima-lora-reference-save-key] PASS:", OUT)
