#!/usr/bin/env python3
"""Replay ZImage SerenityTrainer step-1 AdamW from dumped adapter tensors.

This is a CPU/no-CUDA optimizer replay gate. It consumes the real SerenityTrainer
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replay ZImage SerenityTrainer step001 AdamW update from adapter dumps."
    )
...
def replay(meta_path: Path) -> dict[str, Any]:
    ...
    report = {
        ...
        "evidence_level": "SerenityTrainer AdamW update replay oracle",
        "scope": (
            "full CPU replay of SerenityTrainer step001 AdamW update from dumped "
