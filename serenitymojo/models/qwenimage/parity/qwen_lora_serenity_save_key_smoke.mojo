# qwen_lora_serenity_save_key_smoke.mojo -- Qwen SerenityTrainer save-key contract.
#
...
comptime OUT = "/tmp/qwen_lora_serenity_save_key_smoke.safetensors"
...
def main() raises:
    ...
    print("[qwen-lora-reference-save-key] PASS:", OUT)
