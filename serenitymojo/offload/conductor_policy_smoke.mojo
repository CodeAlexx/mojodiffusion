# conductor_policy_smoke.mojo - no-CUDA gate for SerenityTrainer CPU_OFFLOADED policy.
#
...
def main() raises:
    # SerenityTrainer Flux2 LoRA 8GB preset: CPU_OFFLOADED + layer_offload_fraction=0.7.
    var lora = serenity_trainer_conductor_policy_from_fields(
        True,
        True,
        True,
        Float64(0.7),
    ...
    # SerenityTrainer Flux2 finetune 16GB preset: CPU_OFFLOADED + layer_offload_fraction=0.6.
    var finetune = serenity_trainer_conductor_policy_from_fields(
        True,
        True,
        True,
        Float64(0.6),
    ...
    var no_cuda = serenity_trainer_conductor_policy_from_fields(
        True,
        True,
        True,
        Float64(0.7),
    ...
    var activation_disabled = serenity_trainer_conductor_policy_from_fields(
        True,
        False,
        True,
        Float64(0.7),
    ...
    var plain_on = serenity_trainer_conductor_policy_from_fields(
        False,
        True,
        True,
        Float64(0.7),
    ...
    var raised = False
    try:
        _ = serenity_trainer_conductor_policy_from_fields(
            True,
            True,
            True,
            Float64(1.1),
