...
fn output_port(graph: &Map<String, JsonValue>, src_id: i64, slot: i64) -> GraphResult<String> {
    ...
    let port = match typ.as_str() {
        ...
        // Krea2FlowEdit runs the whole edit ODE + decode; its single output is
        // the final IMAGE (SaveImage terminates it like VAEDecode).
        "Krea2FlowEdit" | "Ideogram4FlowEdit" => (slot == 0).then_some("IMAGE"),
