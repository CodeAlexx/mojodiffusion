...
#
# SerenityTrainer -> diffusers SD3Transformer2DModel uses JointTransformerBlock with
...
def main():
    ...
    print()
    if allok:
        print("VERDICT: PASS — dual-attention block hand math IS the diffusers (SerenityTrainer) math")
    else:
