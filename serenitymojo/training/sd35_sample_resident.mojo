...
# CFG flow-match Euler denoise loop on the SD3.5-Large SerenityTrainer sigma schedule.
...
#   sched  = SD3FlowMatchScheduler.large_default()    # SerenityTrainer set_timesteps,
#                                                       # 28 steps, shift 3.0
...
# build_sd3_serenity_trainer_sigmas the inference scheduler uses.
#
...
from serenitymojo.sampling.sd3_flow_match import build_sd3_serenity_trainer_sigmas
...
def sd35_sample_resident[
    ...
    # SerenityTrainer SD3.5 set_timesteps schedule (n_steps+1 shifted sigmas, last 0.0).
    # Exactly the schedule the gated inference CLI builds
    # (SD3FlowMatchScheduler.large_default -> build_sd3_serenity_trainer_sigmas).
    var sigmas = build_sd3_serenity_trainer_sigmas(n_steps, shift)
