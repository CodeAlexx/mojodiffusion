...
# REAL model (SerenityTrainer -> diffusers SD3Transformer2DModel) runs?
#
# SerenityTrainer's StableDiffusion3Model uses diffusers `SD3Transformer2DModel`, whose
...
def main():
    ...
    print()
    if allok:
        print("VERDICT: PASS — oracle block math IS the diffusers (SerenityTrainer) SD3.5 block math")
    else:
