#!/usr/bin/env python3
"""Static guard for the local SerenityTrainer Z-Image sampler contract.

This is a source-contract and local-artifact evidence gate. It is not an
accepted image-parity or speed-parity claim.
Reference is intentionally limited to /home/alex/SerenityTrainer.
"""
...
SERENITY_SAMPLE_CONFIG = SERENITY_TRAINER / "modules/util/config/SampleConfig.py"
SERENITY_MODEL = SERENITY_TRAINER / "modules/model/ZImageModel.py"
SERENITY_LOADER = SERENITY_TRAINER / "modules/modelLoader/ZImageModelLoader.py"
SERENITY_SAMPLER = SERENITY_TRAINER / "modules/modelSampler/ZImageSampler.py"
SERENITY_SETUP = SERENITY_TRAINER / "modules/modelSetup/BaseZImageSetup.py"
SERENITY_DATALOADER = SERENITY_TRAINER / "modules/dataLoader/ZImageBaseDataLoader.py"
...
COMPARABLE_SPEED_FIELDS: tuple[tuple[str, tuple[str, ...], str], ...] = (
    ...
    (
        "serenity_trainer.denoise_seconds_per_step",
        (
            "serenity_trainer.denoise_seconds_per_step",
            "reference.denoise_seconds_per_step",
            "serenity_denoise_seconds_per_step",
            "serenity_trainer_seconds_per_denoise_step",
        ),
        "positive finite number",
    ),
    (
    ...
    (
        "serenity_trainer.vae_decode_seconds",
        (
            "serenity_trainer.vae_decode_seconds",
            "reference.vae_decode_seconds",
            "serenity_vae_decode_seconds",
        ),
        "positive finite number",
    ),
    (
    ...
    (
        "serenity_trainer.peak_vram_mib",
        ("serenity_trainer.peak_vram_mib", "reference.peak_vram_mib", "serenity_peak_vram_mib"),
        "positive finite number",
    ),
    (
        "mojo.peak_vram_mib",
    ...
    (
        "serenity_trainer.artifact_paths",
        ("serenity_trainer.artifact_paths", "reference.artifact_paths", "serenity_artifact_paths"),
...
STRICT_IDENTITY_FIELDS: tuple[tuple[str, str, tuple[str, ...], tuple[str, ...], tuple[str, ...]], ...] = (
    (
        ...
        "non-empty string",
        (
            "serenity_trainer.prompt",
            "serenity_trainer.sample.prompt",
            "serenity_trainer.run_identity.prompt",
            "reference.prompt",
            "reference.sample.prompt",
            "reference.run_identity.prompt",
        ),
        (
            "mojo.prompt",
            "mojo.sample.prompt",
    ...
    (
        ...
        "integer",
        (
            "serenity_trainer.seed",
            "serenity_trainer.sample.seed",
            "serenity_trainer.run_identity.seed",
            "reference.seed",
            "reference.sample.seed",
            "reference.run_identity.seed",
        ),
        (
            "mojo.seed",
            "mojo.sample.seed",
    ...
    (
        ...
        "positive integer",
        (
            "serenity_trainer.resolution.width",
            "serenity_trainer.width",
            "serenity_trainer.image_width",
            "serenity_trainer.sample.width",
    ...
    (
        ...
        "positive integer",
        (
            "serenity_trainer.resolution.height",
            "serenity_trainer.height",
            "serenity_trainer.image_height",
            "serenity_trainer.sample.height",
    ...
    (
        ...
        "positive integer",
        (
            "serenity_trainer.steps",
            "serenity_trainer.diffusion_steps",
            "serenity_trainer.sample_steps",
            "serenity_trainer.sample.steps",
            "serenity_trainer.run_identity.steps",
            "reference.steps",
            "reference.diffusion_steps",
            "reference.sample_steps",
            "reference.sample.steps",
            "reference.run_identity.steps",
        ),
        (
            "mojo.steps",
    ...
    (
        ...
        "positive finite number",
        (
            "serenity_trainer.guidance",
            "serenity_trainer.guidance_scale",
            "serenity_trainer.cfg",
            "serenity_trainer.cfg_scale",
            "serenity_trainer.sample.guidance",
            "serenity_trainer.sample.guidance_scale",
            "serenity_trainer.sample.cfg_scale",
            "serenity_trainer.run_identity.guidance",
            "reference.guidance",
            "reference.guidance_scale",
            "reference.cfg",
            "reference.cfg_scale",
            "reference.sample.guidance",
            "reference.sample.guidance_scale",
            "reference.sample.cfg_scale",
            "reference.run_identity.guidance",
        ),
        (
            "mojo.guidance",
            "mojo.guidance_scale",
    ...
    (
        ...
        (
            "serenity_trainer.dtype",
            "serenity_trainer.train_dtype",
            "serenity_trainer.transformer_dtype",
            "serenity_trainer.sample.dtype",
            "serenity_trainer.run_identity.dtype",
            "reference.dtype",
            "reference.train_dtype",
            "reference.transformer_dtype",
            "reference.sample.dtype",
            "reference.run_identity.dtype",
        ),
        (
            "mojo.dtype",
            "mojo.train_dtype",
...
STRICT_SIDE_FIELDS: tuple[tuple[str, str, tuple[str, ...], tuple[str, ...]], ...] = (
    (
        ...
        (
            "serenity_trainer.denoise_seconds_per_step",
            "serenity_trainer.denoise.seconds_per_step",
            "reference.denoise_seconds_per_step",
            "reference.denoise.seconds_per_step",
            "serenity_denoise_seconds_per_step",
            "serenity_trainer_seconds_per_denoise_step",
        ),
        (
    ...
    (
        ...
        (
            "serenity_trainer.vae_decode_seconds",
            "serenity_trainer.vae.decode_seconds",
            "reference.vae_decode_seconds",
            "reference.vae.decode_seconds",
            "serenity_vae_decode_seconds",
        ),
        (
            "mojo.vae_decode_seconds",
    ...
    (
        ...
        (
            "serenity_trainer.peak_vram_mib",
            "serenity_trainer.vram.peak_mib",
            "reference.peak_vram_mib",
            "reference.vram.peak_mib",
            "serenity_peak_vram_mib",
        ),
        (
            "mojo.peak_vram_mib",
            "mojo.vram.peak_mib",
    ...
    (
        ...
        (
            "serenity_trainer.artifact_paths",
            "serenity_trainer.artifacts",
            "reference.artifact_paths",
            "reference.artifacts",
            "serenity_artifact_paths",
        ),
        (
            "mojo.artifact_paths",
            "mojo.artifacts",
...
def _doc_can_contribute_strict_shared_identity(data: dict[str, Any]) -> bool:
    ...
    1024px timing evidence impossible to accept even when reference trainer/Mojo fields match.
    """
    schema = data.get("schema")
    if schema in {
        ZIMAGE_SAMPLE_RESULT_SCHEMA,
        "serenity.zimage.sampler_speed.v1",
        "serenity.zimage.serenity_trainer_sampler_speed.v1",
    }:
        return True
    if isinstance(data.get("run_identity"), dict):
        return True
    return isinstance(data.get("serenity_trainer"), dict) or isinstance(data.get("mojo"), dict)
...
def validate_zimage_sample_result(
    ...
    *,
    ...
    print(
        ...
        "strict speed still requires paired SerenityTrainer evidence and positive VRAM"
    )
    return normalized
...
def validate_strict_sampler_speed_fields(
    ...
    for field_name, kind, serenity_aliases, mojo_aliases, shared_aliases in STRICT_IDENTITY_FIELDS:
        serenity_matches, serenity_problems = _valid_alias_matches(flat, serenity_aliases, kind)
        ...
        if not serenity_matches:
            problems.append(
                f"missing serenity_trainer.{field_name}: required {kind}; aliases={serenity_aliases}"
            )
            problems.extend(f"invalid serenity_trainer.{field_name}: {problem}" for problem in serenity_problems)
        if not mojo_matches:
            problems.append(
        ...
        if not (serenity_matches and mojo_matches):
            if shared_matches:
                problems.append(
        ...
        reference = serenity_matches[0]
        mismatches: list[str] = []
        for match in serenity_matches[1:] + mojo_matches + shared_matches:
        ...
        if mismatches:
            problems.append(f"mismatched SerenityTrainer/Mojo sampler identity field {field_name}:")
            problems.extend(mismatches)
            continue

        detail = (
            f"{field_name} matched "
            f"serenity_trainer={_match_source(serenity_matches[0])} mojo={_match_source(mojo_matches[0])}"
        )
        if shared_matches:
            detail += f" shared={_match_source(shared_matches[0])}"
        present.append(detail)

    for field_name, kind, serenity_aliases, mojo_aliases in STRICT_SIDE_FIELDS:
        serenity_matches, serenity_problems = _valid_alias_matches(flat, serenity_aliases, kind)
        mojo_matches, mojo_problems = _valid_alias_matches(flat, mojo_aliases, kind)
        if not serenity_matches:
            problems.append(
        ...
        if not mojo_matches:
            ...
            problems.extend(f"invalid mojo.{field_name}: {problem}" for problem in mojo_problems)
        if serenity_matches and mojo_matches:
            present.append(
                f"{field_name} has paired SerenityTrainer/Mojo evidence "
                f"serenity_trainer={_match_source(serenity_matches[0])} mojo={_match_source(mojo_matches[0])}"
            )
        ...
        "required_identity_fields": [
            {
                "field": field_name,
                "kind": kind,
                "serenity_trainer_aliases": list(serenity_aliases),
...
def write_strict_speed_template(path: Path) -> None:
    template = {
        ...
        "serenity_trainer": {
            "prompt": "REPLACE_WITH_EXACT_PROMPT_USED_FOR_SERENITY_TRAINER_SAMPLE",
            "seed": 0,
            "resolution": {
                "width": 1024,
                "height": 1024,
            ...
            "peak_vram_mib": 0.0,
            "artifact_paths": [
                "REPLACE_WITH_SERENITY_TRAINER_OUTPUT_PATH",
                "REPLACE_WITH_SERENITY_TRAINER_TIMING_OR_LOG_PATH",
            ],
        },
        "mojo": {
...
def validate_speed_metadata(
    ...
    *,
    ...
    if comparable_problems:
        ...
        messages.extend(
            f"{field_name} ({kind}; matching SerenityTrainer/Mojo values; optional shared run_identity must agree)"
            for field_name, kind, _serenity_aliases, _mojo_aliases, _shared_aliases in STRICT_IDENTITY_FIELDS
        )
        messages.extend(
            f"serenity_trainer.{field_name} and mojo.{field_name} ({kind})"
            for field_name, kind, _serenity_aliases, _mojo_aliases in STRICT_SIDE_FIELDS
        )
    ...
    print(
        "[zimage-sampler] PASS "
        f"{label}: comparable SerenityTrainer/Mojo sampler speed metadata is complete"
    )
    ...
    *,
    ...
    require(
        ...
        [
            ...
            "SerenityTrainer + diffusers ONLY",
            "Velocity convention",
    ...
    serenity_png = read_png_ihdr(artifact_dir / "zi_SERENITY_1024.png", "local SerenityTrainer 1024 PNG artifact")
    mojo_png = read_png_ihdr(artifact_dir / "zi_MOJO_1024.png", "local Mojo 1024 PNG artifact")
    png_problems = []
    for name, png in (("SerenityTrainer", serenity_png), ("Mojo", mojo_png)):
    ...
    if serenity_png["width"] != mojo_png["width"] or serenity_png["height"] != mojo_png["height"]:
        png_problems.append(
            f"PNG dimensions differ: reference trainer={serenity_png['width']}x{serenity_png['height']} "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check the Z-Image SerenityTrainer/Mojo source contract and local artifact evidence.",
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
...
def main() -> int:
    ...
    require(
        SERENITY_LOADER,
        "SerenityTrainer Z-Image scheduler loader",
        [
    ...
    require(
        SERENITY_MODEL,
        "SerenityTrainer Z-Image model latent scale and dynamic shift",
        [
    ...
    require_block(
        SERENITY_SAMPLE_CONFIG,
        "SerenityTrainer Z-Image sample defaults",
    ...
    require(
        SERENITY_DATALOADER,
        "SerenityTrainer Z-Image VAE/cache layout",
        [
    ...
    require(
        SERENITY_SAMPLER,
        "SerenityTrainer Z-Image sampler schedule/timestep/latent/CFG",
        [
    ...
    forbid(
        SERENITY_SAMPLER,
        "SerenityTrainer Z-Image sampler has no external pack/unpack",
        [
            "pack_latents(",
            "unpack_latents(",
            "patchify_latents(",
    ...
    require(
        SERENITY_SETUP,
        "SerenityTrainer Z-Image training timestep/noise/flow target",
        [
