...
def main():
    ...
    # q_norm/k_norm intentionally NOT in this list: frozen in production (LoRA),
    # grads discarded (MJ-1035 class, 2026-07-07) -> block uses rms_norm_backward_dx.
    ...
    # ref_d_qnorm/ref_d_knorm no longer dumped: q_norm/k_norm frozen (see above).
