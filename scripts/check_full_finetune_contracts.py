#!/usr/bin/env python3
"""Inventory SerenityTrainer full-finetune contracts and Mojo readiness blockers.

This is a report-first guard. Default mode prints the SerenityTrainer registrations
and separates shared save/resume scaffolding from real product-loop full-finetune
parity evidence. Strict mode fails while any registered SerenityTrainer full-finetune
...
SERENITY_TRAINER = Path("/home/alex/SerenityTrainer")
SERENITY_TRAINER_ANIMA_REF = Path("/home/alex/SerenityTrainer-anima-ref")
SERENITY_SETUP_DIR = SERENITY_TRAINER / "modules/modelSetup"
...
RESUME_CONTRACT = TRAINING_DIR / "serenity_trainer_resume_contract.mojo"
PRODUCT_RUN = TRAINING_DIR / "serenity_trainer_product_run.mojo"
PRODUCT_RUN_SMOKE = TRAINING_DIR / "serenity_trainer_product_run_smoke.mojo"
PARITY_DIR = Path("/home/alex/serenity_trainer-mojo/parity")
...
class Target:
    ...
    reference_root: Path = SERENITY_TRAINER
...
TARGETS: tuple[Target, ...] = (
    Target(
        ...
        model_types=("QWEN",),
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_qwenimage_real.mojo",),
    ),
    Target(
        key="flux1",
        ...
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_flux_real.mojo",),
    ),
    Target(
        key="flux2",
        label="Flux2/Klein",
        ...
        model_types=("FLUX_2",),
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_klein_real.mojo",),
    ),
    Target(
        key="zimage",
        label="Z-Image",
        ...
        model_types=("Z_IMAGE",),
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_zimage_real.mojo",),
    ),
    Target(
        key="chroma",
        label="Chroma",
        ...
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_chroma_real.mojo",),
    ),
    Target(
        key="sdxl",
        label="SDXL",
        ...
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_sdxl_real.mojo",),
    ),
    Target(
        key="sd35",
        label="SD3.5",
        ...
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_sd35_real.mojo",),
    ),
    Target(
        key="ernie",
        label="Ernie",
        ...
        model_types=("ERNIE",),
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_ernie_real.mojo",),
    ),
    Target(
        key="anima",
        label="Anima",
        ...
        model_types=("ANIMA",),
        train_loops=(REPO / "trainer/src/serenity_trainer/trainer" / "train_anima_real.mojo",),
        reference_root=SERENITY_TRAINER_ANIMA_REF,
    ),
)
...
def scan_serenity_trainer_setups(targets: list[Target]) -> dict[str, SetupInfo]:
...
def full_finetune_mojo_contract() -> tuple[bool, str]:
    ...
    required = (
        ...
        "struct SerenityFullFinetuneProductRunPlan",
        ...
        "SERENITY_FULL_FT_LOOP_UNSUPPORTED",
...
def shared_mojo_blockers() -> list[str]:
    ...
    if not mode_ok:
        blockers.append(
            "TrainConfig/readers do not expose a SerenityTrainer-style "
...
def product_loop_proof() -> ProductLoopProof:
    ...
    lifecycle = strip_mojo_comments(read_optional(REPO / "serenitymojo/training/serenity_trainer_lifecycle.mojo"))
    support_claimed = (
        "product_loop_supports_full_finetune = True" in product
        or re.search(
            r"SerenityProductResumePreflight\([^)]*TRAINING_METHOD_FINE_TUNE[^)]*True",
            product,
            flags=re.DOTALL,
        )
        is not None
    ...
    full_runner_dispatch = (
        re.search(
            r"SerenityProductRunPlan\([^)]*SERENITY_PRODUCT_RUNNER_FULL_FINETUNE_REAL",
            lifecycle,
            flags=re.DOTALL,
        )
        is not None
    ...
    positive_full_finetune_smoke = (
        ...
        or re.search(
            ...
            r"(validate_serenity_trainer_train_entrypoint_plan|create_serenity_trainer_train_entrypoint_plan)",
            smoke,
            flags=re.DOTALL,
        )
        is not None
    ...
    detail = (
        ...
        + str(fail_loud_smoke)
        + "; "
        + rel(REPO / "serenitymojo/training/serenity_trainer_lifecycle.mojo")
        + " full_runner_dispatch="
...
def full_weight_evidence_blockers(target: Target, proof: ModelProof) -> list[str]:
    ...
    if not proof.inventory_files:
        blockers.append(
            ...
            "SerenityTrainer checkpoint keys and deterministic trainable-tensor order"
        )
    ...
    if not proof.manifest_files:
        blockers.append(
            ...
            "SerenityTrainer checkpoint keys"
        )
    ...
    if not proof.parity_artifacts:
        blockers.append(
            ...
            "/home/alex/serenity_trainer-mojo/parity"
        )
    return blockers
...
def full_weight_readiness_status(
    ...
    if not found:
        return "serenity_trainer_not_registered"
    if not product_proof.real_full_finetune_loop and shared_count == 0:
        return "serenity_trainer_registered_scaffold_only_product_loop_parity_missing"
    if shared_count or loop_count or evidence_count:
        return "serenity_trainer_registered_product_loop_parity_incomplete"
...
def loop_status(path: Path) -> tuple[bool, str]:
    ...
    shared_lora_only_policy_marker = (
        "validate_serenity_lora_adamw_loop_policy" in text
        or "validate_serenity_train_math_policy" in text
        or "validate_serenity_lora_only_or_fail_full_finetune" in text
    )
    ...
    return {
        "full_weight_inventory": _evidence_bucket(
            ...
            (
                ...
                "using exact SerenityTrainer checkpoint keys and the trainable tensor "
        ...
        "tensor_name_manifest_binding": _evidence_bucket(
            ...
            (
                "ordered tensor-name manifest bound to the SerenityTrainer checkpoint "
        ...
        "parity_artifact": _evidence_bucket(
            ...
            (
                ...
                "/home/alex/serenity_trainer-mojo/parity proving inventory/save/load/"
                "resume behavior against SerenityTrainer"
            ),
        ),
    }
...
TEMPLATE_SECTION_SPECS: tuple[tuple[str, str, str, tuple[str, ...]], ...] = (
    (
        ...
        (
            ...
            "Use exact SerenityTrainer checkpoint keys, not Mojo-only aliases.",
    ...
    (
        "parity",
        "parity_artifact",
        "SerenityTrainer parity artifact",
        (
            "Write a parity manifest under /home/alex/serenity_trainer-mojo/parity.",
...
TARGET_TEMPLATE_ARTIFACTS: dict[str, dict[str, dict[str, object]]] = {
    "flux2": {
        "trainable_tensor_inventory": {
            ...
            "scope": (
                "SerenityTrainer Flux2/Klein FINE_TUNE trains model.transformer "
            ...
            "serenity_trainer_reference_files": [
                (
                    "/home/alex/SerenityTrainer/modules/modelSetup/"
                    "Flux2FineTuneSetup.py::create_parameters and "
                    "__setup_requires_grad"
                ),
                (
                    "/home/alex/SerenityTrainer/modules/model/Flux2Model.py::"
                    "diffusers_checkpoint_to_original"
                ),
                (
                    "/home/alex/SerenityTrainer/modules/modelSaver/flux2/"
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_tensor_inventory.json",
            ],
        },
        "save_load_rebind_hooks": {
            ...
            "serenity_trainer_reference_files": [
                "/home/alex/SerenityTrainer/modules/modelSaver/Flux2FineTuneModelSaver.py",
                "/home/alex/SerenityTrainer/modules/modelLoader/Flux2ModelLoader.py",
                "/home/alex/SerenityTrainer/modules/modelSaver/flux2/Flux2ModelSaver.py",
            ],
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_step000_model.safetensors",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_rebind_roundtrip.json",
            ],
        },
        "ordered_checkpoint_key_manifest": {
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_checkpoint_key_manifest.json",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_name_manifest.safetensors",
            ],
        },
        "optimizer_master_state_sidecar_order": {
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_optimizer_sidecar_order.json",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_step000_train_state.safetensors",
            ],
        },
        "product_resume_proof": {
            ...
            "implementation_files": [
                (
                    "serenitymojo/training/serenity_trainer_lifecycle.mojo::replace "
                    "LoRA-only FINE_TUNE rejection with "
                    "SERENITY_PRODUCT_RUNNER_FULL_FINETUNE_REAL only after model hooks exist"
                ),
                (
                    "serenitymojo/training/serenity_trainer_product_run.mojo::set "
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_product_resume_proof.json",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_resume_roundtrip.safetensors",
            ],
        },
        "parity_artifact_paths": {
            ...
            "required_paths": [
                ...
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_optimizer_sidecar_order.json",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_product_resume_proof.json",
                "/home/alex/serenity_trainer-mojo/parity/klein_full_finetune_parity_report.json",
            ],
    ...
    "zimage": {
        "trainable_tensor_inventory": {
            "status": "missing_next_artifact",
            "scope": (
                "SerenityTrainer Z-Image FINE_TUNE trains model.transformer only; "
            ...
            "serenity_trainer_reference_files": [
                ...
                (
                    "/home/alex/SerenityTrainer/modules/modelSaver/zImage/"
                    "ZImageModelSaver.py::__save_safetensors"
                ),
                "/home/alex/SerenityTrainer/modules/modelLoader/ZImageModelLoader.py",
            ],
            "checkpoint_key_families": [
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_tensor_inventory.json",
            ],
        },
        "save_load_rebind_hooks": {
            "status": "missing_next_artifact",
            ...
            "serenity_trainer_reference_files": [
                "/home/alex/SerenityTrainer/modules/modelSaver/ZImageFineTuneModelSaver.py",
                "/home/alex/SerenityTrainer/modules/modelLoader/ZImageModelLoader.py",
                "/home/alex/SerenityTrainer/modules/modelSaver/zImage/ZImageModelSaver.py",
            ],
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_step000_model.safetensors",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_rebind_roundtrip.json",
            ],
        },
        "ordered_checkpoint_key_manifest": {
            "status": "missing_next_artifact",
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_checkpoint_key_manifest.json",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_name_manifest.safetensors",
            ],
        },
        "optimizer_master_state_sidecar_order": {
            "status": "missing_next_artifact",
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_optimizer_sidecar_order.json",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_step000_train_state.safetensors",
            ],
        },
        "product_resume_proof": {
            "status": "missing_next_artifact",
            ...
            "acceptance_evidence": [
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_product_resume_proof.json",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_resume_roundtrip.safetensors",
            ],
        },
        "parity_artifact_paths": {
            "status": "missing_next_artifact",
            "required_paths": [
                ...
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_optimizer_sidecar_order.json",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_product_resume_proof.json",
                "/home/alex/serenity_trainer-mojo/parity/zimage_full_finetune_parity_report.json",
            ],
            "mojo_consumers_to_add": [
...
def _template_section(
    ...
    return {
        ...
        "serenity_trainer_reference_files_to_fill": _string_list(
            artifact.get("serenity_trainer_reference_files")
        ),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Inventory SerenityTrainer full-finetune registrations and Mojo readiness blockers."
    )
    parser.add_argument(
        "--strict",
        action="store_true",
    ...
    setup_infos = scan_serenity_trainer_setups(selected)
