...
pub struct JobParams {
    ...
    // ── krea2 FlowEdit (training-free instruction edit; Phase C1). A non-empty
    //    edit_src_image marks the job as an EDIT: the krea2 worker runs the
    //    FlowEdit ODE (src image + src/tgt contexts) instead of t2i. The tgt
    //    prompt/negative/cfg/steps/seed ride the existing top-level fields. ──
    pub edit_src_image: String,
    pub edit_src_prompt: String,
    pub edit_src_negative: String,
    /// FlowEdit nmax (-1 = worker default 24) / nmin.
    pub edit_nmax: i64,
    pub edit_nmin: i64,
    /// Source-branch CFG (-1.0 = worker default 1.5).
    pub edit_src_cfg: f64,
    pub edit_auto_mask: bool,
    pub edit_mask_q: f64,
    pub edit_mask_dilate: i64,
    pub edit_mask_warmup: i64,
...
impl Default for JobParams {
    ...
    fn default() -> Self {
        JobParams {
            ...
            edit_src_image: String::new(),
            edit_src_prompt: String::new(),
            edit_src_negative: String::new(),
            edit_nmax: -1,
            edit_nmin: 0,
            edit_src_cfg: -1.0,
            edit_auto_mask: false,
            edit_mask_q: 0.7,
            edit_mask_dilate: 1,
            edit_mask_warmup: 4,
            loras: Vec::new(),
