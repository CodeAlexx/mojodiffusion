...
#   the retained HiDream O1 pipeline reference
...
#   the retained HiDream O1 inference CLI reference
#
...
def denoise(
    ...
    var dit = HiDreamO1Offloaded[SMOKE_S_TOTAL].load(
        String("models/hidream-o1"), cfg, ctx
    )
...
def main() raises:
    hidream_o1_t2i_smoke(
        String("models/hidream-o1"),
        String("models/hidream-o1/tokenizer.json"),
        String("a serene mountain lake at dawn"),
        String("output/hidream_o1_smoke.png"),
    )
