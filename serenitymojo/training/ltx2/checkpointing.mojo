...
#
# SUPERSEDED (P6.0, 2026-07-18): July-10 Codex-era contract SKETCH. The REAL
# checkpoint/save/resume is trainer_core.mojo (save_lora_train_state_f32 +
# trainer_state_meta + the resume-scope guard, P0) as used by train_ltx2_av.
# KEPT (not deleted): serenitymojo/training/parity/ltx2_trainer_parity_audit.mojo
# still imports these names. Do NOT build the AV arm on this file.
