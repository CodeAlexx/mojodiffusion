...
# REAL model (SerenityTrainer -> diffusers ZImageTransformerBlock) runs?
#
# SerenityTrainer's ZImageModel uses diffusers `ZImageTransformer2DModel`, whose main
...
def main():
    ...
    print()
    if allok:
        print("VERDICT: PASS — oracle block math IS the diffusers (SerenityTrainer) block math")
    else:
