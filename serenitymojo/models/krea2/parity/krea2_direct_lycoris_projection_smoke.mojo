...
def _check_streaming_append_and_projection(ctx: DeviceContext) raises:
    ...
    if rb.wd_on_out:
        raise Error("krea2 direct smoke: DoRA readback lost SerenityTrainer input-axis magnitude")
    ...
    var yo_ref_nobias = oft_serenity_forward(
    ...
    var og_ref = oft_serenity_backward(
