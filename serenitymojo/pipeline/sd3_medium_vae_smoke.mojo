# SD3.5 Medium embedded-VAE runtime smoke.
#
...
from serenitymojo.models.dit.sd3_contract import (
    ...
    SD3_MEDIUM_LATENT_H,
    SD3_MEDIUM_LATENT_W,
    validate_sd3_medium_pipeline_contract,
)
...
comptime OUT = "/home/alex/mojodiffusion/output/sd3_medium_vae_noise_1024.png"
comptime SEED = UInt64(43)


def main() raises:
    var manifest = default_manifest_by_id(String("sd3_5_medium"))
    validate_sd3_medium_pipeline_contract(manifest)

    var ctx = DeviceContext()
    print("=== SD3.5 Medium embedded VAE runtime smoke ===")
    print(
        "  latent",
        1,
        "x",
    ...
    var shape = List[Int]()
    shape.append(1)
    shape.append(SD3_MEDIUM_LATENT_CHANNELS)
    shape.append(SD3_MEDIUM_LATENT_H)
    shape.append(SD3_MEDIUM_LATENT_W)
    ...
    print("SD3.5 Medium embedded VAE runtime smoke PASS")
