...
# validation is the P2 val_loss path in train_ltx2_av.mojo (deterministic
# per-val-index sigma+noise, --val_cache_dir/--validate_every). KEPT (not
# deleted): ltx2_trainer_parity_audit.mojo imports these names. Do NOT build on it.
