...
TARGETS: tuple[LoopTarget, ...] = (
    LoopTarget("Qwen", REPO / "trainer/src/serenity_trainer/trainer" / "train_qwenimage_real.mojo"),
    LoopTarget("Ernie", REPO / "trainer/src/serenity_trainer/trainer" / "train_ernie_real.mojo"),
    LoopTarget("Anima", REPO / "trainer/src/serenity_trainer/trainer" / "train_anima_real.mojo"),
    LoopTarget("Klein", REPO / "trainer/src/serenity_trainer/trainer" / "train_klein_real.mojo"),
    LoopTarget("Z-Image", REPO / "trainer/src/serenity_trainer/trainer" / "train_zimage_real.mojo"),
    LoopTarget("Chroma", REPO / "trainer/src/serenity_trainer/trainer" / "train_chroma_real.mojo"),
    LoopTarget("Flux.1", REPO / "trainer/src/serenity_trainer/trainer" / "train_flux_real.mojo"),
    LoopTarget("SD3.5", REPO / "trainer/src/serenity_trainer/trainer" / "train_sd35_real.mojo"),
    LoopTarget("SDXL", REPO / "trainer/src/serenity_trainer/trainer" / "train_sdxl_real.mojo"),
)
...
def scan_loop(target: LoopTarget) -> LoopReport:
    ...
    return LoopReport(
        ...
        preflight_import=first_line(lines, r"serenitymojo\.training\.serenity_trainer_cache_preflight"),
        preflight_create=first_non_import_line(lines, r"\bcreate_serenity_trainer_cache_preflight_plan\s*\("),
        preflight_validate=first_non_import_line(lines, r"\bvalidate_serenity_trainer_cache_preflight_plan\s*\("),
        direct_text_contract=first_line(lines, r"\b(?:serenity_trainer_conditioning_contract|serenity_text_conditioning|SERENITY_TEXT_CACHE)\b"),
        direct_vae_contract=first_line(lines, r"\b(?:vae_encoder_contract|serenity_vae_encoder|SERENITY_VAE_ENCODER)\b"),
