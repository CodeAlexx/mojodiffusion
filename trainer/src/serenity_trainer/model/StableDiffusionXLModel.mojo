...
def _sdxl_vae_scale_apply[decode_mode: Bool](
    ...
    if dt == DType.float32:
        ...
        comptime if decode_mode:
            ctx.enqueue_function[_sdxl_vae_decode_kernel[DType.float32]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
        else:
            ctx.enqueue_function[_sdxl_vae_encode_kernel[DType.float32]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
        ...
        comptime if decode_mode:
            ctx.enqueue_function[_sdxl_vae_decode_kernel[DType.bfloat16]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
        else:
            ctx.enqueue_function[_sdxl_vae_encode_kernel[DType.bfloat16]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
    else:
        ...
        comptime if decode_mode:
            ctx.enqueue_function[_sdxl_vae_decode_kernel[DType.float16]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
        else:
            ctx.enqueue_function[_sdxl_vae_encode_kernel[DType.float16]](X, O, scaling_factor, Int64(n), grid_dim=grid, block_dim=_BLOCK)
    ctx.synchronize()
