...
>      ACTUAL diffusers `ZImageTransformerBlock` (SerenityTrainer's class), F64: fwd +
...
> Reproduce from the repository root: `rm -f serenitymojo.mojopkg && pixi run mojo run -I . serenitymojo/training/zimage_train_step.mojo`
