...
# image (in [-1,1], reference trainer RescaleImageChannels convention) and dumps:
...
def main():
    ...
    # fixed non-degenerate image, then map [0,1)->[-1,1] (reference trainer RescaleImageChannels)
