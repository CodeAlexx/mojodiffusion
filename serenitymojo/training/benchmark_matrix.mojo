...
def training_benchmark_case(index: Int) raises -> TrainingBenchmarkCase:
    ...
    if index == 1:
        return TrainingBenchmarkCase(
            ...
            String("/home/alex/SerenityTrainer one-step and 100-step ZImage artifacts"),
            String("large transformer LoRA"),
            String("BF16"),
            2,
            String("1024"),
            String("SerenityTrainer-primary,batch-2,device-grads"),
    ...
    if index == 2:
        return TrainingBenchmarkCase(
            ...
            String("/home/alex/SerenityTrainer Klein artifacts"),
    ...
    if index == 3:
        return TrainingBenchmarkCase(
            ...
            String("/home/alex/SerenityTrainer SDXL or UNet-family artifacts"),
