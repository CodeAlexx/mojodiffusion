# ernie_lora_serenity_save_key_smoke.mojo -- ERNIE SerenityTrainer save-key contract.
#
# Tiny structural gate: build one synthetic ERNIE LoRA layer, save through
# save_ernie_lora, then inspect the safetensors header and raw reference trainer alpha/down/up
...
comptime OUT = "/tmp/ernie_lora_serenity_save_key_smoke.safetensors"
...
def main() raises:
    ...
    print("[ernie-lora-reference-save-key] PASS:", OUT)
