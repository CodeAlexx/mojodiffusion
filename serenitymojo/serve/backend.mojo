...
struct JobParams(Copyable, Movable):
    ...
    # ── krea2 FlowEdit (Phase C1): a non-empty edit_src_image marks the job as
    #    a training-free instruction EDIT; the tgt prompt/negative/cfg ride the
    #    standard fields. Mirrors the Rust wire JobParams edit_* block. ──
    var edit_src_image: String
    var edit_src_prompt: String
    var edit_src_negative: String
    var edit_nmax: Int          # -1 = worker default (24)
    var edit_nmin: Int
    var edit_src_cfg: Float64   # -1.0 = worker default (1.5)
    var edit_auto_mask: Bool
    var edit_mask_q: Float64
    var edit_mask_dilate: Int
    var edit_mask_warmup: Int
    ...
    def __init__(out self):
        ...
        self.out_dir = String("")
        self.edit_src_image = String("")
        self.edit_src_prompt = String("")
        self.edit_src_negative = String("")
        self.edit_nmax = -1
        self.edit_nmin = 0
        self.edit_src_cfg = -1.0
        self.edit_auto_mask = False
        self.edit_mask_q = 0.7
        self.edit_mask_dilate = 1
        self.edit_mask_warmup = 4
