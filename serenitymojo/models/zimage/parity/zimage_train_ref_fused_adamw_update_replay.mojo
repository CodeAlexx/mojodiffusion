...
#
# Opens the real SerenityTrainer ZImage step000/step001 adapter dumps and replays
...
def main() raises:
    ...
    print(
        "[zimage-fused-adamw-update-mojo] scope=all-420 optimizer-only replay through shared device train-step ABI from real SerenityTrainer adapter safetensors; not transformer forward/backward parity"
    )
