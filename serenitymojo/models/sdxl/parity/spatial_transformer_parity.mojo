...
comptime REF_PATH = (
    "/home/alex/mojodiffusion/serenitymojo/models/sdxl/parity/spatial_transformer_ref.txt"
)
...
def main() raises:
    ...
    print("")
    if all_pass:
        print("ALL SDXL SPATIAL-TRANSFORMER FWD+BWD GATES PASSED (cos >= 0.999 vs PyTorch)")
    else:
