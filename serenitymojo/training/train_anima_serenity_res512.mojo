# serenitymojo/training/train_anima_serenity_res512.mojo
#
...
#       serenitymojo/training/train_anima_serenity_res512.mojo -o /tmp/train_anima_serenity_res512
#   /tmp/train_anima_serenity_res512
...
comptime CACHE_DIR = "/home/alex/EriDiffusion/EriDiffusion-v2/cache/anima_real_serenity512"
...
def main() raises:
    ...
    if len(args) > 2:
        ...
        if v > 0:
            run_steps = v
    print("==== train_anima_serenity_res512 — ANIMA LoRA Serenity recipe training run ====")
