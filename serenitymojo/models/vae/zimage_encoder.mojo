...
#
# Training cache parity with SerenityTrainer uses the deterministic mean latent
...
struct ZImageVaeEncoder[LH: Int, LW: Int](Movable):
    ...
    def encode_mean(self, image_nchw: Tensor, ctx: DeviceContext) raises -> Tensor:
        """Deterministic mean latent NCHW [1,16,LH,LW], matching SerenityTrainer cache mode."""
