...
Reference is intentionally limited to local SerenityTrainer. This does not claim
...
SERENITY_SAMPLER = SERENITY_TRAINER / "modules/modelSampler/QwenSampler.py"
SERENITY_SETUP = SERENITY_TRAINER / "modules/modelSetup/BaseQwenSetup.py"
SERENITY_MODEL = SERENITY_TRAINER / "modules/model/QwenModel.py"
SERENITY_SAMPLE_CONFIG = SERENITY_TRAINER / "modules/util/config/SampleConfig.py"
SERENITY_TRAIN_CONFIG = SERENITY_TRAINER / "configs/qwen_100step_baseline.json"
...
MOJO_SERENITY_SAMPLER_CONTRACT = REPO / "serenitymojo/sampling/serenity_trainer_sampler_contract.mojo"
...
CLAIM_SCAN_FILES = [
    ...
    MOJO_PRODUCT_SMOKE,
    MOJO_SERENITY_SAMPLER_CONTRACT,
...
def run_checks() -> None:
    require(
        ...
        "SerenityTrainer Qwen sample defaults",
        [
    ...
    require(
        SERENITY_SAMPLER,
        "SerenityTrainer Qwen sampler run identity",
        [
            "def __sample_base(",
            "prompt: str",
            "negative_prompt: str",
    ...
    require(
        SERENITY_SAMPLER,
        "SerenityTrainer Qwen denoise path",
        [
    ...
    require(
        SERENITY_SAMPLER,
        "SerenityTrainer Qwen VAE/postprocess path",
        [
    ...
    require(
        SERENITY_SETUP,
        "SerenityTrainer Qwen training/setup flow target",
        [
    ...
    require(
        SERENITY_MODEL,
        "SerenityTrainer Qwen model scale/shift/text contract",
        [
    ...
    require_json_values(
        SERENITY_TRAIN_CONFIG,
        "SerenityTrainer Qwen baseline config",
        {
            "model_type": "QWEN",
    ...
    require(
        ...
        [
            "build_qwenimage_serenity_trainer_sigmas",
    ...
    require(
        MOJO_SERENITY_SAMPLER_CONTRACT,
        "Mojo SerenityTrainer Qwen sampler plan",
        [
