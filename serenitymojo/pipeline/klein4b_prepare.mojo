# klein4b_prepare.mojo — Klein-4B variant of klein_prepare.mojo (wave 3 cont.,
# 2026-07-22). ONLY deltas: Qwen3-4B encoder (klein_4b config, hidden 2560,
# weights/tokenizer from models/klein4b_repo — the FLUX.2-Klein-base-4B repo''s
# own text_encoder) and text_embedding dim 7680 (= 2560 x layers [8,17,26]).
# Same VAE (flux2-vae), same 512px stage contract, same ALL-F32 cache dtype.
#
...
#      -> text_embedding [1,512,7680] (layers [8,17,26] concat).
...
comptime QWEN_DIR = (
    "/home/alex/mojodiffusion/models/klein4b_repo/text_encoder"
)
comptime TOK_JSON = (
    "/home/alex/mojodiffusion/models/klein4b_repo/tokenizer/tokenizer.json"
)
comptime IH = 512
comptime IW = 512
comptime SEQ = 512
...
def main() raises:
    ...
    print("[load] Qwen3-4B encoder (klein_4b config, max_layer=26)")
    ...
    var qenc = Qwen3Encoder.load(QWEN_DIR, Qwen3Config.klein_4b(), ctx, 26)
