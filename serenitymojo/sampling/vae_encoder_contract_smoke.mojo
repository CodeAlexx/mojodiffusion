# Smoke gate for SerenityTrainer VAE encoder/cache readiness contracts.

from serenitymojo.sampling.vae_encoder_contract import (
    SERENITY_VAE_CACHE_LAYOUT_NCDHW_SINGLE_FRAME,
    SERENITY_VAE_CACHE_LAYOUT_NCHW,
    SERENITY_VAE_ENCODER_PARTIAL_PREPARED_ONLY,
    SERENITY_VAE_ENCODER_RAW_CACHE_READY,
    SERENITY_VAE_ENCODER_UNSUPPORTED,
    SERENITY_VAE_PREP_LAYOUT_NCDHW_SINGLE_FRAME,
    SERENITY_VAE_PREP_LAYOUT_NCHW,
    SERENITY_VAE_PREP_SCALE_MUL_SCALING,
    SERENITY_VAE_PREP_SCALE_PATCH_BN,
    SERENITY_VAE_PREP_SCALE_QWEN_MEAN_STD,
    SERENITY_VAE_PREP_SCALE_SUB_SHIFT_MUL_SCALING,
...
def _check_contract(
    ...
    var c = default_serenity_vae_encoder_contract(model_type)
    validate_serenity_vae_encoder_contract(c)
...
def main() raises:
    print("==== SerenityTrainer VAE encoder/cache contract smoke ====")
    ...
    var qwen = default_serenity_vae_encoder_contract(String("QWEN"))
    ...
    var flux2_dev = default_serenity_vae_encoder_contract(String("FLUX_2_DEV"))
    _check(flux2_dev.name == String("flux2_dev"), "Flux2 dev VAE contract name")
    var flux2 = default_serenity_vae_encoder_contract(String("FLUX_2"))
    ...
    print(vae_encoder_contract_summary(default_serenity_vae_encoder_contract(String("FLUX_2_DEV"))))
    print(vae_encoder_contract_summary(default_serenity_vae_encoder_contract(String("FLUX_2"))))
    print("SerenityTrainer VAE encoder/cache contract smoke PASS")
