...
CONTRACTS: dict[Path, tuple[str, ...]] = {
    ...
    ROOT / "serenity-server/canvas/js/canvas-tab.js": (
        ...
        "Load one source image into I2V - LTX 2.3 before generating",
        'id="cv-ltx2-resolution"',
        'type="number" id="cv-ltx2-duration"',
        'for="cv-ltx2-quant">Quality</label>',
        '<option value="bf16">Highest quality · BF16',
    ...
    ROOT / "serenitymojo/sampling/ltx2_request_cli.mojo": (
        ...
        '_require_string(obj, String("quant"))',
        "run_request_profile(",
    ),
