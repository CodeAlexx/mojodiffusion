# sampling/base_sampler.mojo — SHARED sampler parts (the SerenityTrainer
# BaseModelSampler analogue).
#
# SerenityTrainer splits sampling into a BaseModelSampler (shared: device staging,
...
#
# STAGING (SerenityTrainer Flux2Sampler.__sample_base): exactly ONE big model is on
...
# SerenityTrainer BaseModelSampler.quantize_resolution:
...
# SerenityTrainer BaseModelSampler.save_sampler_output (image branch): write a PNG.
