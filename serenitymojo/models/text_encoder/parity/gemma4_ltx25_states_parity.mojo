# LTX-2.5 gate: gemma4_ltx_streamed.mojo vs an oracle built from LIGHTRICKS'
# OWN fine-tuned tower (parity/gemma4_ltx25_oracle_dump.py). The google-weight
# gate does NOT transfer: that encoder is fine-tuned (norm.weight differs in all
# 3840 elements; only frozen buffers like layer_scalar/q_norm match).
#
...
comptime CKPT = String(
    "/home/alex/.serenity/models/text_encoders/gemma4-12b-with-proj-ltx-2.5-bf16.safetensors"
)
comptime REFS = String(
    "/home/alex/mojodiffusion/serenitymojo/models/text_encoder/parity/gemma4_refs_ltx25"
)
...
def main() raises:
    ...
    print("== gemma4 LTX-2.5 real-weight states parity ==")
