...
#  AdapterRotaryEmbedding) which is the SAME class SerenityTrainer's AnimaModel.py
...
# ── REAL adapter dims (TRAINING_PLAN_anima.md §C; ckpt shapes) ──
B = 1
S_TXT = 512        # PROMPT_MAX_LENGTH (AnimaModel.py:23)
S_LLM = 512        # Qwen3 hidden seq (reference trainer also 512)
