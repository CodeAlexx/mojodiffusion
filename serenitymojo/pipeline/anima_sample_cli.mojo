...
# z/inv_std + mean == SerenityTrainer AnimaModel.unscale_latents. The ONLY deltas vs that
...
# ── LoRA recipe (matches train_anima_serenity_res512: RANK=16, ALPHA=16) ────────────
comptime RANK = 16
...
# Identical math to train_anima_serenity_res512._rope_tables + anima_dit.build_anima_3d_rope,
