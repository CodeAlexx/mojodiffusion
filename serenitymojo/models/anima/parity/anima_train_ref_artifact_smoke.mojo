# anima_train_ref_artifact_smoke.mojo -- no-CUDA Anima SerenityTrainer artifact gate.
#
# Opens the real /home/alex/SerenityTrainer-anima-ref 100-step Anima LoRA artifact
# and validates the raw SerenityTrainer LoRA safetensors inventory. This is an
...
comptime SERENITY_BASELINE = "/home/alex/SerenityTrainer-anima-ref/output/anima_100step_baseline/lora.safetensors"
...
def main() raises:
    var path = String(SERENITY_BASELINE)
    _require(_file_exists(path), String("missing SerenityTrainer Anima artifact: ") + path)
