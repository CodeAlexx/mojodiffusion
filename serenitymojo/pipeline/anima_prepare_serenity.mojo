# serenitymojo/pipeline/anima_prepare_serenity.mojo
#
...
#       serenitymojo/pipeline/anima_prepare_serenity.mojo -o /tmp/anima_prepare_serenity
#   /tmp/anima_prepare_serenity <image.png> <out_cache_dir>
...
def _image_to_nchw_m1p1(
    ...
    if w != IW or h != IH:
        raise Error(
            String("anima_prepare_serenity: image must be ") + String(IW) + "x"
...
def main() raises:
    ...
    print("==== anima_prepare_serenity — REAL VAE encode for the trainer ====")
