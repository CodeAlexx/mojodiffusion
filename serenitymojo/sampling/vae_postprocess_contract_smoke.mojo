# Smoke gate for SerenityTrainer VAE/postprocess sampler contracts.

from serenitymojo.sampling.vae_postprocess_contract import (
    SERENITY_IMAGE_POSTPROCESS_ANIMA_FRAME0_DENORM_TRUE,
    SERENITY_IMAGE_POSTPROCESS_ERNIE_MANUAL_UINT8,
    SERENITY_IMAGE_POSTPROCESS_QWEN_SQUEEZE_DENORM_TRUE,
    SERENITY_IMAGE_POSTPROCESS_VAE_DEFAULT,
    SERENITY_IMAGE_POSTPROCESS_VAE_DENORM_TRUE,
    SERENITY_VAE_DECODE_BN_UNSCALE_UNPATCHIFY,
    SERENITY_VAE_DECODE_DIV_SCALE,
    SERENITY_VAE_DECODE_DIV_SCALE_ADD_SHIFT,
    SERENITY_VAE_DECODE_QWEN_MEAN_STD,
    SERENITY_VAE_LAYOUT_ANIMA_5D_SINGLE_FRAME,
    SERENITY_VAE_LAYOUT_ERNIE_PATCHIFIED_NCHW,
    SERENITY_VAE_LAYOUT_FLUX2_PATCHIFIED_SEQUENCE,
    SERENITY_VAE_LAYOUT_FLUX_2X2_SEQUENCE,
    SERENITY_VAE_LAYOUT_NCHW,
    SERENITY_VAE_LAYOUT_QWEN_2X2_SEQUENCE_5D,
    bn_unscale_value,
    default_serenity_vae_contract,
    ...
    validate_serenity_vae_contract,
...
def _check_contract(
    ...
    var c = default_serenity_vae_contract(model_type)
    validate_serenity_vae_contract(c)
...
def main() raises:
    print("==== SerenityTrainer VAE/postprocess contract smoke ====")
    ...
    var qwen = default_serenity_vae_contract(String("QWEN"))
    ...
    print(vae_contract_summary(default_serenity_vae_contract(String("FLUX_2_DEV"))))
    print(vae_contract_summary(default_serenity_vae_contract(String("FLUX_2"))))
    print("SerenityTrainer VAE/postprocess contract smoke PASS")
