...
# port a deterministic SerenityTrainer-key order to build those pieces against.
...
def zimage_full_finetune_tensor_names() -> List[String]:
    ...
    SerenityTrainer Z-Image full finetune trains the transformer while VAE and text
