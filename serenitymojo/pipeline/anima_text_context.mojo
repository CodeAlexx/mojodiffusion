...
#
# Anima TEXT -> CONTEXT @512 end-to-end (Chunk C, TRAINING_PLAN_anima.md §C).
#
# Runs the FULL SerenityTrainer text path (AnimaModel.encode_text) in pure Mojo:
...
#      schema) so train_anima_serenity.mojo consumes a real per-caption context.
#
# TOKENIZER NOTE (deviation, stated per task): the SerenityTrainer recipe tokenizes
