...
def main() raises:
    ...
    var yo_ref = oft_serenity_forward(x.copy(), oft.ad[slot].vec.copy(), W.copy(), M, dims[0], dims[1], block_size, dims[0] // block_size)
    ...
    var og_ref = oft_serenity_backward(d_y.copy(), x.copy(), oft.ad[slot].vec.copy(), W.copy(), M, dims[0], dims[1], block_size, dims[0] // block_size)
