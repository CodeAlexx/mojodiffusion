...
It consumes the real SerenityTrainer Klein adapter dump and models the local host
...
It does not run Klein predict/backward_lora, does not compare SerenityTrainer moment
payloads, does not prove CUDA/GPU parity, and does not prove a real nonzero
SerenityTrainer update because the captured SerenityTrainer step has lr_before=0.0.
"""
...
def inspect(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "scope": (
            ...
            "SerenityTrainer Klein adapter_post_clip_grad; not CUDA/GPU parity, "
            "predict/backward_lora parity, or real nonzero SerenityTrainer update parity"
        ),
        "meta": str(args.meta),
