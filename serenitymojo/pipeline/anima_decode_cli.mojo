...
# z/inv_std + mean, matching SerenityTrainer AnimaModel.unscale_latents before
...
# z_dim=16). Standard sampler/trainer latents are already in SerenityTrainer SCALED
