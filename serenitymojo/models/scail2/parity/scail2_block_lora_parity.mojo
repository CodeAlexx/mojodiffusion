# serenitymojo/models/scail2/parity/scail2_block_lora_parity.mojo
#
...
def main() raises:
    ...
    print("==== scail2_block_lora_parity (SCAIL-2 i2v F32-residual DUAL cross-attn + 12 LoRA) ====")
    ...
    var g = scail2_block_lora_backward[S, TXT, IMG, H, DH](
