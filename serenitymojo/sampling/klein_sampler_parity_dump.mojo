...
# producer for paired SerenityTrainer sampler parity.
#
...
# SerenityTrainer-side artifacts as blockers unless a paired reference trainer producer supplies
# them.
...
def _build_manifest_json(
    ...
    out += String("  \"parity_note\":\"Mojo artifacts are real; SerenityTrainer artifacts and numeric comparisons must be supplied by a paired reference trainer run before strict acceptance.\",\n")
    ...
    out += String("\"serenity_trainer_seed_replay_inputs\":[\"serenity_trainer_initial_noise_raw_nchw\",\"serenity_trainer_initial_noise_post_patch_nchw\",\"serenity_trainer_initial_noise_post_pack\"],")
    out += String("\"paired_latent_trajectory\":[{\"serenity_trainer\":\"serenity_trainer_latent_trajectory\",\"mojo\":\"mojo_latent_trajectory\"},{\"serenity_trainer\":\"serenity_trainer_final_packed_latent\",\"mojo\":\"mojo_final_packed_latent\"},{\"serenity_trainer\":\"serenity_trainer_final_unpacked_latent\",\"mojo\":\"mojo_final_unpacked_latent\"},{\"serenity_trainer\":\"serenity_trainer_final_unscaled_unpatchified_latent\",\"mojo\":\"mojo_final_unscaled_unpatchified_latent\"}],")
    out += String("\"paired_decode_and_png\":[{\"serenity_trainer\":\"serenity_trainer_vae_decoded_tensor\",\"mojo\":\"mojo_vae_decoded_tensor\"},{\"serenity_trainer\":\"serenity_trainer_png\",\"mojo\":\"mojo_png\"}]},\n")
    out += String("  \"artifacts\":{\n")
    out += String("    \"serenity_trainer_initial_noise_raw_nchw\":")
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_initial_noise_raw_nchw.bin")), String("F32"), raw_shape)
    out += String(",\n    \"serenity_trainer_initial_noise_post_patch_nchw\":")
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_initial_noise_post_patch_nchw.bin")), String("F32"), post_patch_shape)
    ...
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_latent_trajectory.bin")), String("F32"), trajectory.shape())
    ...
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_final_packed_latent.bin")), String("F32"), final_packed.shape())
    ...
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_final_unpacked_latent.bin")), String("F32"), final_packed.shape())
    ...
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_final_unscaled_unpatchified_latent.bin")), String("F32"), final_unscaled.shape())
    ...
    out += _tensor_artifact_json(_join(out_dir, missing + String("serenity_trainer_vae_decoded_tensor.bin")), String("F32"), decoded_shape)
    ...
    out += _png_artifact_json(_join(out_dir, String("MISSING_serenity_trainer_png.png")), prompt.width, prompt.height)
    out += String(",\n    \"mojo_png\":")
    out += _png_artifact_json(png_path, prompt.width, prompt.height)
    out += String("\n  },\n")
    out += String("  \"metrics\":{\"serenity_trainer\":{\"denoise_seconds_per_step\":0.0,\"vae_decode_seconds\":0.0,\"peak_vram_mib\":0.0},\"mojo\":{")
    ...
    out += String("\"trajectory\":{\"accepted\":false,\"max_abs\":null,\"tolerance\":null,\"note\":\"No paired reference trainer comparison has been run.\"},")
    out += String("\"final_latent\":{\"accepted\":false,\"max_abs\":null,\"tolerance\":null,\"note\":\"No paired reference trainer comparison has been run.\"},")
    out += String("\"vae_png\":{\"accepted\":false,\"max_abs\":null,\"tolerance\":null,\"note\":\"No paired reference trainer comparison has been run.\"}},\n")
