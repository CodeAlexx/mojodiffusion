...
# Anima-Standalone-Trainer LLMAdapter source (== the class SerenityTrainer's
...
def main() raises:
    ...
    # NOTE: oracle fixtures predate the reference trainer attention masks. Pass an all-ones
