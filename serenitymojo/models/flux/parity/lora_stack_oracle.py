...
# SerenityTrainer Flux LoRA target set (convert_flux_lora.py:6-41): LoRA on the SPLIT
...
# on the 3 D-slices of the fused qkv output (the reference trainer-faithful per-projection model)
...
GUIDANCE = 3.5
RANK = 4
ALPHA = 1.0               # reference trainer default
LSCALE = ALPHA / RANK
