# bf16_stochastic_rounding.mojo -- SerenityTrainer BF16 stochastic rounding helper.
#
# SerenityTrainer copies F32 values into BF16 optimizer tensors with stochastic
# rounding. This helper is the core-side mirror used by SerenityTrainer-parity
