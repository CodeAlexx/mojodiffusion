# Host-resident Klein LoRA adapter and SerenityTrainer-style AdamW.
#
# This is the mojodiffusion core counterpart of the SerenityTrainer-named Klein port
...
# rounding to match SerenityTrainer's optimizer behavior.
