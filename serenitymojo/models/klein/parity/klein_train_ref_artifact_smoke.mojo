# klein_train_ref_artifact_smoke.mojo -- Klein/Flux2 SerenityTrainer one-step artifact gate.
#
# Header/payload-only, no-CUDA gate. It opens the real local SerenityTrainer Klein
...
# SerenityTrainer step, sampler, speed, or image parity.
...
comptime META_JSON = "/home/alex/serenity_trainer-mojo/parity/klein_train_ref_meta.json"
comptime STEP_DUMP = "/home/alex/serenity_trainer-mojo/parity/klein_train_ref_step000.safetensors"
comptime ADAPTER_DUMP = "/home/alex/serenity_trainer-mojo/parity/klein_train_ref_step000_adapters.safetensors"
...
def _require_tensor(
    ...
    _require(key in st.tensors, String("missing Klein reference trainer tensor ") + key)
    var info = st.tensor_info(key)
    _require(
        info.dtype == dtype,
...
def _check_meta_json() raises:
    ...
    _require(meta.byte_length() > 0, String("empty Klein SerenityTrainer metadata JSON"))
    ...
    _require_contains(
        meta,
        String("\"safetensors\": \"/home/alex/serenity_trainer-mojo/parity/klein_train_ref_step000.safetensors\""),
        String("step safetensors path"),
    )
    _require_contains(
        meta,
        String("\"adapter_safetensors\": \"/home/alex/serenity_trainer-mojo/parity/klein_train_ref_step000_adapters.safetensors\""),
