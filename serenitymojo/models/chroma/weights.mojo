...
def _load_double_stream(
    st: ShardedSafeTensors, bp: String,
...
def _load_dev_preserve(st: ShardedSafeTensors, name: String, ctx: DeviceContext) raises -> Tensor:
...
def load_chroma_stack_base(
    st: ShardedSafeTensors, num_double: Int, num_single: Int, ctx: DeviceContext
