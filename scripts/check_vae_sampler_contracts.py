#!/usr/bin/env python3
"""Static guard for SerenityTrainer VAE/postprocess sampler contracts.

Reference is intentionally limited to local SerenityTrainer plus the repo-local Anima
contract mirror when SerenityTrainer-anima-ref is not present. This guard checks the
...
ANIMA_REF = Path("/home/alex/SerenityTrainer-anima-ref")
...
def main() -> int:
    samplers = SERENITY_TRAINER / "modules/modelSampler"
    models = SERENITY_TRAINER / "modules/model"
    ...
    if not anima_ref_available:
        print(
            "[vae-sampler] INFO SerenityTrainer-anima-ref unavailable; "
            "using repo-local Anima VAE contract mirror"
        )

    require(
        samplers / "BaseModelSampler.py",
        "SerenityTrainer base quantization",
        [
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/StableDiffusionXLBaseDataLoader.py",
        "SerenityTrainer SDXL VAE encode/precache",
        [
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/StableDiffusion3BaseDataLoader.py",
        "SerenityTrainer SD3.5 VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/QwenBaseDataLoader.py",
        "SerenityTrainer Qwen VAE encode/precache",
        [
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/Flux2BaseDataLoader.py",
        "SerenityTrainer Flux2 dev/Klein VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
            "image_split_names = ['latent_image', 'original_resolution', 'crop_offset']",
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/ErnieBaseDataLoader.py",
        "SerenityTrainer Ernie VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
            "image_split_names = ['latent_image', 'original_resolution', 'crop_offset']",
    ...
    if anima_ref_available:
        require(
            ...
            "SerenityTrainer-anima VAE scaling source",
            [
        ...
        require(
            ...
            "SerenityTrainer-anima VAE encode/precache",
            [
                "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
        ...
        require(
            REPO / "serenitymojo/training/train_anima_serenity.mojo",
        ...
        require(
            REPO / "serenitymojo/pipeline/anima_prepare_serenity.mojo",
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/FluxBaseDataLoader.py",
        "SerenityTrainer Flux VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
        ],
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/ChromaBaseDataLoader.py",
        "SerenityTrainer Chroma VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
        ],
    ...
    require(
        SERENITY_TRAINER / "modules/dataLoader/ZImageBaseDataLoader.py",
        "SerenityTrainer Z-Image VAE encode/precache",
        [
            "EncodeVAE(in_name='image', out_name='latent_image_distribution', vae=model.vae",
            "SampleVAEDistribution(in_name='latent_image_distribution', out_name='latent_image', mode='mean')",
        ],
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseFlux2Setup.py",
        "SerenityTrainer Flux2 dev/Klein prepared latent shape",
        [
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseErnieSetup.py",
        "SerenityTrainer Ernie prepared latent shape",
        [
            "latent_image = model.patchify_latents(batch['latent_image'].float())",
            "scaled_latent_image = model.scale_latents(latent_image)",
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseQwenSetup.py",
        "SerenityTrainer Qwen prepared latent shape",
        [
    ...
    if anima_ref_available:
        require(
            ...
            "SerenityTrainer-anima prepared latent shape",
            [
                "latent_image = batch['latent_image']",
                "scaled_latent_image = model.scale_latents(latent_image)",
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseStableDiffusionSetup.py",
        "SerenityTrainer SDXL prepared latent scale",
        ["scaled_latent_image = latent_image * vae_scaling_factor"],
    )
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseStableDiffusion3Setup.py",
        "SerenityTrainer SD3.5 prepared latent scale",
        ["scaled_latent_image = (latent_image - vae_shift_factor) * vae_scaling_factor"],
    )
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseFluxSetup.py",
        "SerenityTrainer Flux prepared latent scale",
        [
            "scaled_latent_image = (latent_image - vae_shift_factor) * vae_scaling_factor",
            "packed_latent_input = model.pack_latents(latent_input)",
        ],
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseChromaSetup.py",
        "SerenityTrainer Chroma prepared latent scale",
        [
            "scaled_latent_image = (latent_image - vae_shift_factor) * vae_scaling_factor",
            "packed_latent_input = model.pack_latents(latent_input)",
        ],
    ...
    require(
        SERENITY_TRAINER / "modules/modelSetup/BaseZImageSetup.py",
        "SerenityTrainer Z-Image prepared latent scale",
        ["scaled_latent_image = model.scale_latents(batch['latent_image'])"],
    )
    require(
        samplers / "StableDiffusionXLSampler.py",
        "SerenityTrainer SDXL VAE decode/postprocess",
        [
    ...
    require(
        ...
        "SerenityTrainer SD3.5 VAE decode/postprocess",
        [
    ...
    require(
        models / "QwenModel.py",
        "SerenityTrainer Qwen VAE latent layout",
        [
    ...
    require(
        ...
        "SerenityTrainer Qwen decode/postprocess",
        [
    ...
    require(
        ...
        "SerenityTrainer Ernie patchify/BN unscale",
        [
    ...
    require(
        ...
        "SerenityTrainer Ernie decode/manual postprocess",
        [
    ...
    if anima_ref_available:
        require(
            anima_models / "AnimaModel.py",
            "SerenityTrainer-anima Qwen-image VAE scaling",
            [
                "AutoencoderKLQwenImage",
                "latents_mean = torch.tensor(self.vae.config.latents_mean",
                "latents_std = 1.0 / torch.tensor(self.vae.config.latents_std",
        ...
        require(
            ...
            "SerenityTrainer-anima decode/postprocess",
            [
        ...
        require(
            ...
            [
                ...
                "z/inv_std + mean, matching SerenityTrainer AnimaModel.unscale_latents",
    ...
    require(
        models / "FluxModel.py",
        "SerenityTrainer Flux pack/unpack",
        [
    ...
    require(
        ...
        "SerenityTrainer Flux decode/postprocess",
        [
            "vae_scale_factor = 8",
    ...
    require(
        ...
        "SerenityTrainer Flux2 dev/Klein patchify/BN",
        [
            "def patchify_latents(latents: torch.Tensor) -> torch.Tensor:",
            "latents = latents.permute(0, 1, 3, 5, 2, 4)",
    ...
    require(
        ...
        "SerenityTrainer Flux2 dev/Klein decode/postprocess",
        [
            "vae_scale_factor = 8",
    ...
    require(
        ...
        "SerenityTrainer Chroma decode/postprocess",
        [
            "vae_scale_factor = 8",
            "num_latent_channels = 16",
            "latent_image = self.model.pack_latents(latent_image)",
    ...
    require(
        ...
        "SerenityTrainer Z-Image scale/unscale",
        [
    ...
    require(
        ...
        "SerenityTrainer Z-Image decode/postprocess",
        [
            "vae_scale_factor = 8",
    ...
    require(
        ...
        [
            "SERENITY_VAE_LAYOUT_FLUX_2X2_SEQUENCE",
            "SERENITY_VAE_LAYOUT_QWEN_2X2_SEQUENCE_5D",
            "SERENITY_VAE_DECODE_QWEN_MEAN_STD",
            "SERENITY_VAE_DECODE_BN_UNSCALE_UNPATCHIFY",
            "SERENITY_IMAGE_POSTPROCESS_ERNIE_MANUAL_UINT8",
            "qwenimage_unscale_value",
            "bn_unscale_value",
            "ernie_manual_uint8_value",
        ],
    )
    require(MOJO_SMOKE, "Mojo VAE/postprocess smoke", ["SerenityTrainer VAE/postprocess contract smoke PASS"])
    ...
    require(
        ...
        [
            "ZImageVaeEncoder",
            "def encode_mean(self, image_nchw: Tensor, ctx: DeviceContext) raises -> Tensor:",
            "matching SerenityTrainer cache mode",
        ],
    )
    require(
    ...
    require(
        ...
        [
            "SerenityTrainer VAE encoder/cache contract smoke PASS",
