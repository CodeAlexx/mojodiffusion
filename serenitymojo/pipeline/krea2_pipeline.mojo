...
comptime LT_POS = 24           # vrtlEri2 garden-portrait prompt, measured by krea2_encode_cli
comptime LT_NEG = 5
...
def main() raises:
    ...
    if use_resident:
        ...
        resident = Optional[Krea2ResidentFp8](
            # resident_blocks == NBLOCKS: FULL fp8 residency (the historical
            # behavior; the partial-residency arg was added for 16GB trainers).
