...
def main() raises:
    ...
    # P6.0: run the extended acceptance contract (audio 672 / audio_ref 864
    # surface counts + audio cache-key contract) end-to-end.
    print("--- acceptance contract (run_acceptance) ---")
    _ = run_acceptance(False)
    print("  PASS acceptance contract (incl. P6.0 audio surface + cache keys)")
