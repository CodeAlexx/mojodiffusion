# klein_lora_serenity_save_key_smoke.mojo -- Klein SerenityTrainer save-key contract.
#
...
comptime OUT = "/tmp/klein_lora_serenity_save_key_smoke.safetensors"
...
def main() raises:
    ...
    print("[klein-lora-reference-save-key] PASS:", OUT)
