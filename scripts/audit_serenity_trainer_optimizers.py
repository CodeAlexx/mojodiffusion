#!/usr/bin/env python3
"""Audit local SerenityTrainer preset optimizer identifiers.
...
ROOTS = (
    Path("/home/alex/SerenityTrainer/training_presets"),
    Path("/home/alex/SerenityTrainer/configs"),
...
def main() -> int:
    ...
    print("Local SerenityTrainer optimizer audit")
