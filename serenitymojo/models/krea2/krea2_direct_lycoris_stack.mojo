...
from serenitymojo.training.oft_serenity_trainer_device import (
    OFTOTDeviceGrads, oft_serenity_rotate_b4, oft_serenity_rotate_backward_b4,
)
...
def krea2_direct_oft_projection_forward_resident(
    ...
    var x_rot = oft_serenity_rotate_b4(x, slot_dev.vec[], ctx)
...
def krea2_direct_oft_projection_backward_resident(
    ...
    return oft_serenity_rotate_backward_b4(d_x_rot^, x, slot_dev.vec[], ctx)
