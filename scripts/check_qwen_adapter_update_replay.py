#!/usr/bin/env python3
"""Qwen-Image SerenityTrainer adapter update-bearing readiness gate.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Inspect the Qwen SerenityTrainer adapter dump and report whether an "
...
def required_update_artifacts(meta: dict[str, Any], meta_path: Path) -> dict[str, Any]:
    ...
    requirements = [
        {
            "name": "step dump",
            "requirement": "SerenityTrainer tensor dump for optimizer step 1",
