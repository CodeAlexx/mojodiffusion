...
def sdxl_unet_stack_backward_reduced(
    ...
    # out_gn d_g/d_b were never read (not in SdxlStackGradsReduced) -> d_x only.
    var d_h = group_norm_backward_dx(
        d_silu, acts.final_gn_in, w.out_gn_w, RG, GN_EPS_RES, ctx
    )    # grad into out5 output [B,8,8,16]
