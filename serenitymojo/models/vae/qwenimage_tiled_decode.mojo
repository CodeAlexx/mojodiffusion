...
def wan21_image_tiled_decode_with_decoder[
    ...
    var b = cast_tensor(dec.decode_wan21_keys(slice(r, 3, half_w, TILE_W, ctx), ctx), STDtype.F32, ctx)
    ...
    b = cast_tensor(dec.decode_wan21_keys(slice(r, 3, half_w, TILE_W, ctx), ctx), STDtype.F32, ctx)
