...
from serenitymojo.training.oft_serenity_trainer import (
    OFTOTGrads, oft_serenity_forward, oft_serenity_backward,
)
...
def flat_direct_oft_forward_slot(
    ...
    ref sl = set.ad[slot]
    return oft_serenity_forward(x_h, sl.vec, w_orig, M, sl.in_f, sl.out_f, sl.b, sl.r)
...
def flat_direct_oft_backward_slot(
    ...
    ref sl = set.ad[slot]
    return oft_serenity_backward(d_y_h, x_h, sl.vec, w_orig, M, sl.in_f, sl.out_f, sl.b, sl.r)
