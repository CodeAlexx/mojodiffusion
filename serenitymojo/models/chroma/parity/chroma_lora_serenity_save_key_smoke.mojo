# chroma_lora_serenity_save_key_smoke.mojo -- Chroma SerenityTrainer save-key contract.
#
...
comptime OUT = "/tmp/chroma_lora_serenity_save_key_smoke.safetensors"
comptime FILTER_OUT = "/tmp/chroma_lora_serenity_save_key_filter_smoke.safetensors"
...
def main() raises:
    ...
    print("[chroma-lora-reference-save-key] PASS:", OUT)
